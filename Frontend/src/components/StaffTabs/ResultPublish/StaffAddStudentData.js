...
const AddStudentExamData = () => {
  ...
  const [coScholastic, setCoScholastic] = useState([...defaultCoScholastic]);
  ...
  useEffect(() => {
    const fetchExistingData = async () => {
      ...
      setCoScholastic([...defaultCoScholastic]);
      ...
      try {
        ...
        if (data.status === "success" && data.count > 0) {
          ...
          console.log("Health Status Data:", existingData.health_status);
          setIsEditMode(true);
        ...
        <div className="col-12">
          <div className="card p-0">
            <div className="card-body exam-data-container">
              ...
              >
                COURSE EXAM RESULT {isEditMode && <span className="badge bg-warning text-dark ms-2">Editing Existing Data</span>}
              </p>
                        ...
                        <tr key={index}>
                          ...
                          >
                            <Select
                              ...
                              value={gradeOptions.find(opt => opt.value === activity.grade) || null}
