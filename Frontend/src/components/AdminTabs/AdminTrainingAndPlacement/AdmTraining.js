                    ...
                    <div className="row flex-grow-1 mb-3 mt-3 ">
                      ...
                      <div className="col-md-3 mb-3">
                        ...
                        {batchesLoading ? (
                          ...
                          <Select
                            ...
                            value={
                              BatchList?.find((b) => b.id === Number(filters.batchId))
                                ? {
                      ...
                      <div className="col-md-3 mb-3">
                        ...
                        <Select
                          ...
                          value={
                            CourseList?.find((c) => c.id === Number(filters.courseId))
                              ? {
                      ...
                      <div className="col-md-3 mb-3">
                        ...
                        <Select
                          ...
                          value={
                            DepartmentList?.find((d) => d.id === Number(filters.departmentId))
                              ? {
                      ...
                      <div className="col-md-3 mb-3">
                        ...
                        <Select
                          ...
                          value={
                            AcademicYearList?.find((y) => y.id === Number(filters.academicYearId))
                              ? {
                      ...
                      <div className="col-md-3 mb-3">
                        ...
                        <Select
                          ...
                          value={
                            SemesterList?.find((s) => s.id === Number(filters.semesterId))
                              ? {
