                    ...
                    <div className="col-md-3 mb-3">
                      ...
                      {/* <Select
                        ...
                        options={
                          LectureList?.map((l) => ({
                            value: l.id,
                            label: l.lecture_period_name || l.lecture_period_description || "Unnamed Period",
                          })) || []
                        }
                        value={
                          LectureList.find((l) => l.id === Number(formData.feeappfrom))
                            ? {
                              value: formData.feeappfrom,
                              label:
                                LectureList.find((l) => l.id === Number(formData.feeappfrom))
                                  ?.lecture_period_name || "Unnamed Period",
                            }
                            : null
                        }
                        onChange={(opt) =>
