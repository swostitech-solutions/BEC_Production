...
const BookCategoryMaster = () => {
  ...
  const handleSave = async () => {
    ...
    const data = {
      category_name: categoryName,      // Changed from CategoryName
      category_description: "",
      org_id: orgId,
      branch_id: branchId,
      is_active: true,                  // Changed from "Y" to boolean
      created_by: 1,
    };
  ...
  const paginatedSubCategories = bookCategories.slice(
    (currentPage - 1) * itemsPerPage,
    currentPage * itemsPerPage
  );
  
  // Show loading state while initial data is being fetched or categories are loading
    ...
    <div className="container-fluid mt-0">
      ...
      <div className="card p-4 mb-0">
        ...
        <div className="table-responsive">
          ...
          <Pagination
            totalItems={bookCategories.length}
