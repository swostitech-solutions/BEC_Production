...
const AdmOtherDetails = ({ formData, setFormData }) => {
  ...
  //             const previewUrl =
  //               doc.document_url ||
  //               `${ApiUrl.apiurl}${doc.document_pic || ""}`;
                ...
                <tr key={index}>
                  ...
                  {/* <td>
                    ...
                    >
                      ...
                      {documentTypes.map((docType, i) => (
                        <option key={docType.id} value={docType.document_code}>
                  ...
                  {/* <td>
                    <input
                      ...
                      onChange={(e) =>
                        handleInputChange(index, "start_from", e.target.value)
                      }
                    />
                  </td>
                  ...
                  <td>
                    <input
                      ...
                      value={row.end_to}
                      onChange={(e) =>
                        handleInputChange(index, "end_to", e.target.value)
                      }
                    />
                  </td> */}
