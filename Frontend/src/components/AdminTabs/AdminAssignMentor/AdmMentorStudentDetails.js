                ...
                <div className="col-12 custom-section-box">
                  <div className="row">
                    ...
                    <div className="col-12 col-md-4 mb-3">
                      <label className="form-label fw-bold">Select Mentor</label>
                        <Select
                          options={mentors}
                    ...
                    <div className="col-12 col-md-4 mb-3">
                      <label className="form-label fw-bold">Select Student</label>
                        ...
                        placeholder={selectedMentor ? "Select Student" : "Select Mentor first"}
                        isDisabled={!selectedMentor || students.length === 0}
                          isClearable
                        isLoading={loading && selectedMentor && !selectedStudent}
                        noOptionsMessage={() => 
                          selectedMentor 
                      ...
                      <tr>
                        ...
                        <td className="text-start">
                            {studentDetails?.student_name || 
                             `${studentDetails?.first_name || ""} ${studentDetails?.middle_name || ""} ${studentDetails?.last_name || ""}`.trim() || 
                             " "}
                        </td>
                        ...
                        <td className="text-start">
                          ...
                          <td className="fw-bold text-start">College Admission No</td>
                          <td className="text-start">
                        ...
                        <tr>
                          <td className="fw-bold text-start">Student Mobile No</td>
                          <td className="text-start">
