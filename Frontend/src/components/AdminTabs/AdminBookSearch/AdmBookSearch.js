...
const AdmBookSearch = () => {
 ...
 const handleClear = () => {
  ...
  const handleLocationChange = (selectedOption) => {
    setLocation(selectedOption ? selectedOption.value : ""); // Save the location ID (value)
  };
...
const handleSearch = async () => {
  ...
  try {
    ...
    if (response.ok && result.message === "success" && result.data.length > 0) {
      setTableData(result.data); // Set table data if available
                    ...
                    <div className="row flex-grow-1">
                      ...
                      <div className="col-12 col-md-3 mb-1">
                        ...
                        <Select
                          ...
                          value={
                            typeofBooks
                              ? { value: typeofBooks, label: typeofBooks }
                              : null
                          }
