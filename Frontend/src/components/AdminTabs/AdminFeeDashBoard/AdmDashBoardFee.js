...
const FeeDashboard = () => {
  ...
  useEffect(() => {
    if (selectedMonthValue !== undefined && selectedYearValue !== undefined) {
      ...
      console.log(
        `📅 Date Range: ${start_date} to ${end_date} (${lastDay} days)`,
      );
    ...
    fetch(url2)
      ...
      .then((data) => {
        if (data?.data) {
          ...
          const totalCollectable =
            sessionData.element_amount - sessionData.total_discount_amount;
          const totalBalance = totalCollectable - sessionData.total_paid_amount;
              ...
              >
                ...
                >
                  ...
                  <Select
                    id="sessionYear"
                    value={
                      yearOptions.find((opt) => opt.value === sessionFeeYear) ||
                      null
                    }
                ...
                >
                  ...
                  >
                    <li>
                      ...
                      {sessionFeeDetails.totalDues?.toLocaleString() || "0.00"}
                    </li>
                    <li>
