...
useEffect(() => {
  ...
  const handlePasswordReset = () => {
    ...
    // Add your API logic here for password update
  ...
  return (
    <div
      style={{
        backgroundImage: "url('/img/bec.png')",
        backgroundSize: "cover", // zooms the image
        backgroundRepeat: "no-repeat",
        backgroundPosition: "center", // 👈 keeps middle, crops top & bottom
        minHeight: "100vh",
        display: "flex",
        alignItems: "flex-end",
        ...
        <Row className="justify-content-center">
          <Col md={6}>
            <Card
              ...
              style={{
                backgroundColor: "#000000ff", // deep black
                opacity: 0.95,
