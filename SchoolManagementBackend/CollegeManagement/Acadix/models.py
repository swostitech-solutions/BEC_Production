...
class StudentFeeReceiptHeader(models.Model):
    ...
    cancelled_by_name = models.CharField(max_length=255, null=True, blank=True)
    cancelled_by_role = models.CharField(max_length=100, null=True, blank=True)
...
class StudentTransferCertificate(models.Model):
    ...
    date_of_admission = models.CharField(max_length=50, null=True, blank=True)
    ...
    religion_caste = models.CharField(max_length=200, null=True, blank=True)
    permanent_address = models.TextField(null=True, blank=True)
    class_last_studied = models.CharField(max_length=500, null=True, blank=True)
    general_conduct = models.CharField(max_length=500, null=True, blank=True)
    qualified_for_promotion = models.CharField(max_length=500, null=True, blank=True)
    reason_for_tc = models.CharField(max_length=500, null=True, blank=True)
    from_month = models.CharField(max_length=100, null=True, blank=True)
    to_month = models.CharField(max_length=100, null=True, blank=True)
...
class StudentBonafideCertificate(models.Model):
    ...
    admission_quota = models.CharField(max_length=200, null=True, blank=True)
    current_year = models.CharField(max_length=100, null=True, blank=True)
    year_from = models.CharField(max_length=10, null=True, blank=True)
    year_to = models.CharField(max_length=10, null=True, blank=True)
    course_fee_y1 = models.CharField(max_length=100, null=True, blank=True)
    course_fee_y2 = models.CharField(max_length=100, null=True, blank=True)
    course_fee_y3 = models.CharField(max_length=100, null=True, blank=True)
    course_fee_y4 = models.CharField(max_length=100, null=True, blank=True)
    hostel_fee_y1 = models.CharField(max_length=100, null=True, blank=True)
    hostel_fee_y2 = models.CharField(max_length=100, null=True, blank=True)
    hostel_fee_y3 = models.CharField(max_length=100, null=True, blank=True)
    hostel_fee_y4 = models.CharField(max_length=100, null=True, blank=True)
    misc_fee_y1 = models.CharField(max_length=100, null=True, blank=True)
    misc_fee_y2 = models.CharField(max_length=100, null=True, blank=True)
    misc_fee_y3 = models.CharField(max_length=100, null=True, blank=True)
    misc_fee_y4 = models.CharField(max_length=100, null=True, blank=True)
    grand_total_y1 = models.CharField(max_length=100, null=True, blank=True)
    grand_total_y2 = models.CharField(max_length=100, null=True, blank=True)
    grand_total_y3 = models.CharField(max_length=100, null=True, blank=True)
    grand_total_y4 = models.CharField(max_length=100, null=True, blank=True)
    certificate_status = models.CharField(max_length=100, choices=CertificateStatus, default=CertificateStatus.Pending)
    created_by = models.PositiveIntegerField(default=1)
    updated_by = models.PositiveIntegerField(null=True, blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
