            ...
            if filterdata:
                ...
                for item in filterdata:
                    ...
                    data = {
                        ...
                        'semester': item.semester.semester_description or item.semester.semester_code,
                        ...
                        'lecture_period_description': item.lecture_period.lecture_period_description,
                        'lecture_time_from': item.lecture_period.time_from.strftime('%H:%M') if item.lecture_period.time_from else None,
                        'lecture_time_to': item.lecture_period.time_to.strftime('%H:%M') if item.lecture_period.time_to else None,
