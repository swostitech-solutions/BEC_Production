...
urlpatterns = [
    ...
    path('api/StudentCertificate/GetStudentDetailsBasedOnDocumentTypeStudentId/',
         views.GetstudentDetailsbasedOncertificateStudentId.as_view(),
         name='GetStudentDetailsBasedOnStudentIdDocumentType'),
