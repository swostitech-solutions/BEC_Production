...
from Acadix.models import Department, Organization, AcademicYear, Course, Batch, Semester, Section, UserLogin, \
    ...
    Lecture, CourseDepartmentSubject, EmployeeType, Designation, EmployeeMaster, TimeTable, \
    ...
    MessageInitiated, \
    StudentMessagesHistory, StudentAssignment, StudentCircular, Bank, BankAccountDetail, StudentCertificate, Branch, \
    Login
