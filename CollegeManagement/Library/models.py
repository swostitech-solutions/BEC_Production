...
from Acadix.models import Organization, Batch, AcademicYear, StudentRegistration, Employee
...
class LibraryBooksIssues(models.Model):
    ...
    professor = models.ForeignKey(Employee,on_delete=models.CASCADE,null=True,blank=True)
