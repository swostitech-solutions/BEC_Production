...
class StudentHostelDetailsRetrieveAPIView(RetrieveAPIView):
    ...
    def retrieve(self, request, *args, **kwargs):
        ...
        try:
            ...
            choice_semester_list = ast.literal_eval(StudentHostelDetailInstance.choice_semester)
            responseData={
                ...
                "fee_applied_from_id": choice_semester_list[0]
    ...
    def update(self, request, *args, **kwargs):
        try:
            ...
            # Update the student record
                ...
                studentCourseInstance.hostel_choice_semester = choice_semester_ids
        ...
        try:
            ...
            if hostel_avail:
                ...
                if studentCourseInstance.hostel_choice_semester:
                    hostel_choice_semester_ids =  ast.literal_eval(studentCourseInstance.hostel_choice_semester)
    ...
    def list(self, request, *args, **kwargs):
        try:
            ...
            if filterdata:
                ...
                studentWise_data = student_fee_qs.values('student_id').annotate(
...
class StudentAllFeesCalculationBasedOnElement(ListAPIView):
    ...
    def list(self, request, *args, **kwargs):
        try:
            ...
            fee_summary = student_fee_record.values("fee_applied_from", "element_name").annotate(
...
class GetHostelRoomList(APIView):
    def get(self,request):
        ...
        if not (organization_id and branch_id and hostel_id and hostel_block_id and hostel_block_floor_id and room_type_id):
            ...
            try:
                hostel_room_instance= HostelRoom.objects.filter(organization=organization_id, branch=branch_id,hostel=hostel_id,hostel_block=hostel_block_id, is_active=True)
            except HostelBlockFloor.DoesNotExist:
...
class GetHostelRoomBedList(APIView):
    def get(self,request):
        ...
        if not (organization_id and branch_id and hostel_id and hostel_block_id and hostel_block_floor_id and room_type_id and room_id):
            ...
            try:
                hostel_room_bed_instance= HostelRoomBed.objects.filter(organization=organization_id, branch=branch_id,hostel=hostel_id,hostel_block=hostel_block_id,room=room_id, is_active=True)
