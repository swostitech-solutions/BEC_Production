...
from Acadix.models import ExceptionTrack, TimeTable, AcademicYear, Organization, Branch, EmployeeMaster, \
    Course, Section, CourseDepartmentSubject, Period, Lecture, Batch, Department, Semester
...
from TIME_TABLE.serializers import  TimeTableSerializer, TimeTableSearchBasedOnCriteria, \
    ...
    LecturePlanListSearchCriteriaSerializer
...
class TimeTableEntryForProfessors(CreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        try:
            ...
            try:
                lectureInstance = Lecture.objects.get(id=lecture_id, is_active=True)
            ...
            if filterdata:
                ...
                for item in filterdata:
                    ...
                    data = {
                        ...
                        'lecture': item.lecture.lecture_name,
