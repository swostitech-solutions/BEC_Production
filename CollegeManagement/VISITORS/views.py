        ...
        try:
            ...
            if visitorlistrecord:
                ...
                if serializer.validated_data.get('from_date'):
                    visitorlistrecord= visitorlistrecord.filter(visit_date__date__gte=serializer.validated_data.get('from_date'))


                if serializer.validated_data.get('to_date'):
                    visitorlistrecord= visitorlistrecord.filter(visit_date__date__lte= serializer.validated_data.get('to_date'))
