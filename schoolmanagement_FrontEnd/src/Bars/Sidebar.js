    ...
    >
      <List>
        {(userRole === "principal" || userRole === "admin") && (
          <>
            {isModuleAccessible("dashboard") &&
              createExpandableSection(
                "Dashboards",
                <MdDashboard />,
                [
                  isChildAccessible("dashboard.fee_dashboard") && {
                    path: "/admin/fee-dashboard",
                    text: "Accounts fee status",
                  },
                  isChildAccessible("dashboard.attendance") && {
                    path: "/admin/student-attendance-list",
                    text: "Attendance",
                  },
                ].filter(Boolean),
              )}
            {isModuleAccessible("student") &&
              createExpandableSection(
                "Student",
                <PiStudentBold />,
                [
                  isChildAccessible("student.registration") && {
                    path: "/admin/registration",
                    text: "Registration",
                  },
                  isChildAccessible("student.attendance") && {
                    path: "/admin/Attendance-update",
                    text: "Attendance",
                  },
                  isChildAccessible("student.assignment") && {
                    path: "/admin/assignment-entry",
                    text: "Assignment",
                  },
                  isChildAccessible("student.promotion") && {
                    path: "/admin/student-promotion",
                    text: "Promotion",
                  },
                  isChildAccessible("student.class") && {
                    path: "/admin/student-class",
                    text: "Student Course",
                  },
                  isChildAccessible("student.confirm") && {
                    path: "/admin/student-confirm",
                    text: "Student Confirm",
                  },
                  isChildAccessible("student.certificate") && {
                    path: "/admin/student-certificate",
                    text: "Student Certificate",
                  },
                  isChildAccessible("student.message") && {
                    path: "/admin/student-message",
                    text: "Student Message",
                  },
                  isChildAccessible("student.club") && {
                    path: "/admin/student-club",
                    text: "Student Club",
                  },
                  isChildAccessible("student.circular") && {
                    path: "/admin/circular-entry",
                    text: "Circulars",
                  },
                ].filter(Boolean),
              )}
            ...
            {isModuleAccessible("staff") &&
              createExpandableSection(
                ...
                [
                  isChildAccessible("staff.registration") && {
                    path: "/admin/employee-search",
                    text: "Registration",
                  },
                ].filter(Boolean),
              )}
            {isModuleAccessible("fee") &&
              createExpandableSection(
                "Fee",
                <BsCashCoin />,
                [
                  isChildAccessible("fee.search") && {
                    path: "/admin/fee-search",
                    text: "Search",
                  },
                  isChildAccessible("fee.adhoc") && {
                    path: "/admin/adhoc-fees",
                    text: "ADHOC Fees",
                  },
                  isChildAccessible("fee.ledger") && {
                    path: "/admin/fee-ledger",
                    text: "Fee Ledger",
                  },
                  isChildAccessible("fee.student_fee") && {
                    path: "/admin/student-fee",
                    text: "Student Fee",
                  },
                  isChildAccessible("fee.structure") && {
            ...
            {isModuleAccessible("library") &&
              createExpandableSection(
                ...
                <HiOutlineLibrary />,
                [
                  isChildAccessible("library.dashboard") && {
                    path: "/admin/book-dashboard",
                    text: "Book Dashboard",
                  },
                  isChildAccessible("library.category") && {
                    path: "/admin/book-category",
                    text: "Book Category",
                  },
                  isChildAccessible("library.search") && {
                    path: "/admin/book-search",
                    text: "Search",
                  },
                  isChildAccessible("library.configurations") && {
                    path: "/admin/book-Configurations",
                    text: "Book Configurations",
                  },
                  isChildAccessible("library.movements") && {
                    path: "/admin/book-movements",
                    text: "Issue/Return",
                  },
                  isChildAccessible("library.barcode") && {
                    path: "/admin/book-barcode",
                    text: "Book Barcode",
                  },
                  isChildAccessible("library.title_report") && {
                    path: "/admin/book-title-report",
                    text: "Book Title Report",
                  },
                  isChildAccessible("library.journal_report") && {
                    path: "/admin/book-journal-report",
                    text: "Journal Report",
                  },
                  isChildAccessible("library.accession_report") && {
                    path: "/admin/book-accession-report",
                    text: "	Book Accession Report",
                  },
                  isChildAccessible("library.issue_return_report") && {
                    path: "/admin/book-issue-return-report",
                    text: "Issue/Return Report",
                  },
                  isChildAccessible("library.damaged_report") && {
                    path: "/admin/book-issue-damaged-report",
                    text: "	Lost/Damaged Report",
                  },
                  isChildAccessible("library.most_circulated") && {
                    path: "/admin/book-most-circulated",
                    text: "Most Circulated Book Report",
                  },
                ].filter(Boolean),
              )}
            {isModuleAccessible("exam_results") &&
              createExpandableSection(
                "Exam Results",
                <PiExam />,
                [
                  isChildAccessible("exam_results.result") && {
                    path: "/admin/result",
                    text: "Result",
                  },
                ].filter(Boolean),
              )}
            {isModuleAccessible("transport") &&
              createExpandableSection(
                "Transport",
                <FaBusAlt />,
                [
                  isChildAccessible("transport.search") && {
                    path: "/admin/transport-search",
                    text: " Search",
                  },
                  isChildAccessible("transport.student_fee") && {
                    path: "/admin/student-transport-fee",
                    text: "Student Transport",
                  },
                ].filter(Boolean),
              )}
            {isModuleAccessible("expense") &&
              createExpandableSection(
                "Expense",
                <FaMoneyBillTransfer />,
                [
                  isChildAccessible("expense.search") && {
                    path: "/admin/search-expense",
                    text: "Search Expense",
                  },
                  isChildAccessible("expense.category") && {
                    path: "/admin/expense-category",
                    text: "Expense/Income Category",
                  },
                  isChildAccessible("expense.party_master") && {
                    path: "/admin/party-master",
                    text: "Party Master",
                  },
                  isChildAccessible("expense.ledger") && {
                    path: "/admin/expense-ledger",
                    text: "Expense Ledger",
                  },
                  isChildAccessible("expense.profit_loss") && {
                    path: "/admin/profit-loss",
                    text: "Profit & Loss",
                  },
                  isChildAccessible("expense.day_book") && {
                    path: "/admin/day-book",
                    text: "Day Book",
                  },
                ].filter(Boolean),
              )}
            {isModuleAccessible("other_income") &&
              createExpandableSection(
                "Other Income",
                <GiMoneyStack />,
                [
                  isChildAccessible("other_income.search") && {
                    path: "/admin/Search-income",
                    text: "Search Income",
                  },
                ].filter(Boolean),
              )}
            {isModuleAccessible("hostel") &&
              createExpandableSection(
                "Hostel",
                <MdOutlineAddHomeWork />,
                [
                  isChildAccessible("hostel.search") && {
                    path: "/admin/search-hostel",
                    text: "Search ",
                  },
                  isChildAccessible("hostel.student_details") && {
                    path: "/admin/student-hostel-details",
                    text: "Student Hostel Details",
                  },
                  isChildAccessible("hostel.student_fee") && {
                    path: "/admin/student-hostel-fee",
                    text: "Student Hostel Fee ",
                  },
                ].filter(Boolean),
              )}
            {isModuleAccessible("timetable") &&
              createExpandableSection(
                "TimeTable",
                <FaRegCalendarTimes />,
                [
                  isChildAccessible("timetable.class") && {
                    path: "/admin/class-time-table",
                    text: "Class TimeTable",
                  },
                  isChildAccessible("timetable.teacher") && {
                    path: "/admin/teacher-time-table",
                    text: "Teacher TimeTable",
                  },
                ].filter(Boolean),
              )}
            {isModuleAccessible("lessonplan") &&
              createExpandableSection(
                "LessonPlan",
                <FaBookOpen />,
                [
                  isChildAccessible("lessonplan.lesson_plan") && {
                    path: "/admin/lesson-plan",
                    text: "Lesson Plan",
                  },
                  isChildAccessible("lessonplan.teacher") && {
                    path: "/admin/teacher-lesson-plan",
                    text: "Teacher Lesson Plan",
                  },
                ].filter(Boolean),
              )}
            {isModuleAccessible("mentor") &&
              createExpandableSection(
                "Mentor",
                <PiChalkboardTeacher />,
                [
                  isChildAccessible("mentor.assign") && {
                    path: "/admin/assign-mentor",
                    text: "Assign Mentor",
                  },
                  isChildAccessible("mentor.follow_ups") && {
                    path: "/admin/follows-ups",
                    text: "Follow Ups",
                  },
                  isChildAccessible("mentor.student_details") && {
            ...
            {isModuleAccessible("academics") &&
              createExpandableSection(
                ...
                [
                  isChildAccessible("academics.document_upload") && {
            ...
            {isModuleAccessible("grievance") &&
              createExpandableSection(
                "Grievance",
                <LuBaggageClaim />,
                [
                  isChildAccessible("grievance.student") && {
                    path: "/admin/student-grievance",
                    text: "Student Grievances",
                  },
                ].filter(Boolean),
              )}
            {isModuleAccessible("visitors") &&
              createExpandableSection(
                "Visitors",
                <FaPeopleGroup />,
                [
                  isChildAccessible("visitors.list") && {
                    path: "/admin/visitors-list",
                    text: "Visitors List",
                  },
                ].filter(Boolean),
              )}
            {isModuleAccessible("mou") &&
              createExpandableSection(
                "MOU",
                <RiNewspaperLine />,
                [
                  isChildAccessible("mou.list") && {
                    path: "/admin/mou-list",
                    text: "Mou List",
                  },
                ].filter(Boolean),
              )}
            {isModuleAccessible("training_placements") &&
              createExpandableSection(
                "Training and Placements",
                <ImOffice />,
                [
                  isChildAccessible("training_placements.training") && {
                    path: "/admin/training",
                    text: "Training",
                  },
                ].filter(Boolean),
              )}
            {isModuleAccessible("inventory") &&
              createExpandableSection(
                "Inventory Management",
                <FaWarehouse />,
                [
                  isChildAccessible("inventory.category") && {
                    path: "/admin/inventory",
                    text: "Inventory Category",
                  },
                  isChildAccessible("inventory.search") && {
                    path: "/admin/inventory-search",
                    text: "Inventory Search",
                  },
                ].filter(Boolean),
              )}
            {isModuleAccessible("role") &&
              createExpandableSection(
                "Role",
                <PersonAddOutlinedIcon />,
                [
                  isChildAccessible("role.create_admin_user") && {
                    path: "/admin/create-admin-user",
                    text: "Create New Role",
                  },
                  isChildAccessible("role.change_password") && {
