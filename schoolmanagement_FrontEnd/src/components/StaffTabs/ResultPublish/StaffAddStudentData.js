        ...
        <div className="col-12">
          <div className="card p-0">
            <div className="card-body exam-data-container">
              ...
              <div className="row mt-3 mx-2">
                <div className="col-12">
                  <div className="custom-section-box p-3" style={{ border: "1px solid #ccc", borderRadius: "5px" }}>
                    <h5 className="mb-3">Upload Document</h5>
                    <Form.Group controlId="formFile" className="mb-3">
                      <Form.Label>Select Document (PDF, Image)</Form.Label>
                      <Form.Control
                        type="file"
                    ...
                    {existingReport && (
                      <div className="mt-3">
                        <p className="text-muted">
                          ...
                          <a
                            href={`${ApiUrl.apiurl.replace(/\/api\/$/, '')}${existingReport.pdf_url}`}
                            target="_blank"
                          ...
                          <span className="ms-2 small text-muted">
                            ({new Date(existingReport.generated_date).toLocaleDateString()})
                          </span>
                        </p>
                      </div>
                    )}
